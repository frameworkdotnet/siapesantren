...
<div class="containers" style="background-color:#1e427c;color:white;">
	...
	<p style="font-size:25px;">TOKO ONLINE</p>
</div>
<div class="container2">
	<p class="content">Kami segenap XXXXX mengucapkan terima banyak kasih kepada <?php echo strtoupper($nama); ?>, karena telah ikut serta berpartisipasi dalam program kami</p>
	<p class="content1">Berikut adalah detail pendaftaran anda : </p>
	<p class="content1">Nama : <?php echo strtoupper($nama); ?></p>
	<p class="content1">Username : <?php echo $username; ?></p>
	<p class="content1">Password : <?php echo $password; ?></p>
	<p class="content">Klik link ini <?php echo $link; ?> </p>
	<p class="content">Gunakan <b>username & password</b> diatas untuk login kedalam sistem kami</p>
</div>
